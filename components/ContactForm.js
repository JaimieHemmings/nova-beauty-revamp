        ...
        <section class="body-font relative">
            <div class="container mx-auto px-5 py-24">
                ...
                <div class="mb-12 flex w-full flex-col text-center">
                    ...
                    <p class="mx-auto lg:w-2/3 text-white">Feel free to reach out to us! Whether you have a question,
                    ...
                    <div class="-m-2 flex flex-wrap">
                        <div class="w-1/2 p-2">
                            <div class="relative">
                                ...
                                <label for="name" class="absolute left-3 -top-6 text-sm leading-7 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm">Name</label>
                            </div>
                        </div>
                        <div class="w-1/2 p-2">
                            <div class="relative">
                                ...
                                <label for="email" class="absolute left-3 -top-6 bg-transparent text-sm leading-7 text-indigo-500 transition-all peer-placeholder-shown:left-3 peer-placeholder-shown:top-2  peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-focus:left-3 peer-focus:-top-6 peer-focus:text-sm">Email</label>
                            </div>
                        </div>
